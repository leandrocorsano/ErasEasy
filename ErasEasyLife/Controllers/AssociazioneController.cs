...
namespace ErasEasyLife.Controllers
{
    public class AssociazioneController : Controller
    {
        ...
        public ActionResult Dashboard()
        {
            ...
            if (ass != null) //controllo se l'utente è loggato
            {
            ...
            try
            {
                if ((ModelState.IsValid))
                {
                    ...
                    else
                    {
                        ...
                        ViewBag.url = "../Associazione/Registra";
        ...
        public ActionResult Modifica_Profilo(Models.Associazione model)
        {
            ...
            if (a != null) //controllo che la sessione non sia scaduta
            {
                try
                {
                    if (ModelState.IsValid)
        ...
        {
            Association.Associazione a = (Association.Associazione)Session["associazione"];
            if (a != null) //controllo se l'utente è loggato
            {
                try
                {
                    if ((ModelState.IsValid))
        ...
        public ActionResult Elenco(Models.Associazione model)
        {
            ...
            { return View("Errore_Sessione"); } //se la sessione è scaduta
        ...
        public ActionResult Aggiungi_ruolo(Models.Volontario model)
        {
            ...
            if (ass != null) //controllo se l'utente è loggato
            {
             ...
             {
                return View("Errore_Sessione"); //la sessione è scaduta
            }
        }
